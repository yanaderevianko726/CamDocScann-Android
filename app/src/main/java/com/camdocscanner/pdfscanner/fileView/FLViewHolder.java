package com.camdocscanner.pdfscanner.fileView;
...
public class FLViewHolder extends RecyclerView.ViewHolder {
    ...
    public final String APP_TAG = "Cam Doc Scann";
        ...
        this.itemLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( adapter.multiSelect ){
                    ...
                    String pathOfFile = document.getPath();
                    int length = pathOfFile.length();
                    String formatOfFile = pathOfFile.substring(length-3, length).toLowerCase();
                    ...
                    Uri sharedFileUri = FileProvider.getUriForFile(v.getContext(), "com.camdocscanner.pdfscanner.provider", toOpen);

                    if(formatOfFile.equals("pdf")) {
